...
~/curl-impersonate/curl-impersonate-chrome -L --create-dirs https://www.sbi.co.in/documents/16012/1400784/FOREX_CARD_RATES.pdf --output ~/sbi-tt-rates-historical/$(date '+%Y')/$(date '+%m')/$(date '+%Y-%m-%d-%H:%M').pdf
git add .
